...
public class DodgeballManager {
	...
	private DodgeballNode throwerList; // you can rename this if you want
	private DodgeballNode dodgerList; // you can rename this if you want
	private DodgeballNode benchList; // you can rename this if you want
